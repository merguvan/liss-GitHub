...
function Summary({ personalInfo, addressInfo }) {
  return (
    <Card className="person-summary">
      ...
      <Collapse
        in={[...Object.keys(personalInfo), ...Object.keys(addressInfo)].some(
      ...
      >
        <div className="person-summary-container">
          ...
          <div className="person-name-container">
            <p>
              {" "}
              <span>{personalInfo.personTitle}</span>
              {personalInfo.personName + " " + personalInfo.personSurname}
            </p>
