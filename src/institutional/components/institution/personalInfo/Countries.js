...
export default function Countries({
  ...
  return (
    <Form.Group>
      <Form.Row>
        <Col xs={12} md={6} lg={6}>
          <Form.Label className="font-weight-bold">Country of Birth</Form.Label>
          <Form.Control
        ...
        <Col xs={12} md={6} lg={6}>
          <Form.Group>
            <Form.Label className="font-weight-bold">City of Birth</Form.Label>
            <Form.Control
              name="personCityOB"
          ...
          {cities.length > 0 && citiesOptionsOn && (
            <ListGroup name="personCityOB" className="city-container">
              {cities?.map((city, idx) => (
                <ListGroup.Item
                  key={idx}
