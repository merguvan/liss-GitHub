...
},
{
  ...
  personCertificateDoc:true,
  personCertificateGrade:"",
  personCertificateTopic:"Social Distancing and it's Applicability out of Pandemic Times",
        ...
        <div className="work_experience_block">
          ...
          <div className="person-summary-body-context-container">
              ...
              <div className="person-summary-body-context-container_level_1">
                <p>
                  {i.personCertificationInstitutionName +
                    ", " +
                    i.personCertificationInstitutionCity +", "+ i.personCertificationInstitutionCountry}
                </p>
              </div>
            </h6>
            ...
            <div className="person-summary-body-context-container_level_2">
              <p><em>Certification of Achievements on <br/> "{i.personCertificateTopic}"</em></p>
            </div>
            <div className="person-summary-body-context-container_level_3">
              <div>
                {" "}
                <p>{i.personCertificateFrom + " - " + i.personCertificateTo}</p>
              </div>
            </div>
          </div>
        </div>
